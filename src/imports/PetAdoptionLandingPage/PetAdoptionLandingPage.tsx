...
import imgImage3 from "figma:asset/9454f91fce9e5214dc9ff8b02cd0332a7039c7fe.png";
import imgImage7 from "figma:asset/1e9849d13a0b644f82eadce2da5525778537dae6.png";
import imgImage2 from "figma:asset/a4dc20a82cb8d933274abe6781201d2989656bbd.png";
import imgGeminiGeneratedImageRmm4V8Rmm4V8Rmm41 from "../../assets/Herosectionbackground.png";
import imgImage15 from "figma:asset/a7866d29e4780753510254295b12e47b847d44e2.png";
import imgAdoptMePet020320211 from "figma:asset/caa24ff1a8850a94ca7a7aa0ad695e37cf5785c3.png";
import imgScreenshot202604141108541 from "figma:asset/46087fae1e7011e10003d977f8cfee57ade21bdf.png";
import imgConfusedCat1 from "figma:asset/708b735cf3dc3c422efdc79e8551743cc00ebf97.png";
import imgEllipse3 from "figma:asset/3c5613ea99708792c16fec180099686f7514eaa9.png";
import imgDogTips1 from "figma:asset/46aa201904c47742d8ed961b9a407fd0c0050cc0.png";
import imgConfusedPuppy1 from "figma:asset/38932c894b1ff0bc8ddf0bbe629b2dd80d20690d.png";
import imgCatTips1 from "figma:asset/05d115c58ea3255032e4dc3852e875be7e5ae086.png";
...
function Component77951261HandDrawnPaintPawPrint() {
  return (
...
function Button() {
  return (
    <button className="absolute -translate-x-1/2 left-[calc(50%+0.5px)] top-[397px] group flex items-center gap-[10px] rounded-full bg-white pl-5 pr-1.5 py-1 text-[20px] font-semibold text-[#4cbfff] shadow-[0px_4px_8px_rgba(76,191,255,0.38)] border-b-[0.5px] border-[rgba(0,106,255,0.37)] transition-transform hover:scale-105 active:scale-95" data-name="Button">
      <span className="leading-[24px]">Find a new Friend</span>
...
function Group71() {
  return (
    <div className="absolute bottom-0 contents left-0">
      <div className="absolute bottom-0 h-[559px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-1.508px] mask-size-[1440px_560.509px] w-[1440px]" style={{ maskImage: `url('${imgImage16}')` }} data-name="image 15">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Footer() {
  return (
    <div className="absolute bottom-0 h-[560.508px] left-0 overflow-clip w-[1440px]" data-name="Footer">
      <Group71 />
      <div className="absolute bottom-0 h-[224px] left-0 w-[1440px]" data-name="Screenshot 2026-04-14 110854 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function AdoptNowButton() {
  return (
    <div className="absolute left-1/2 -translate-x-1/2 top-[1700px] z-[50] flex items-center justify-center pointer-events-auto">
      <button className="group flex items-center gap-[27px] rounded-full bg-white pl-5 pr-1.5 py-1 text-[20px] font-semibold text-[#4cbfff] shadow-[0px_4px_8px_rgba(76,191,255,0.38)] border-b-[0.5px] border-[rgba(0,106,255,0.37)] transition-transform hover:scale-105 active:scale-95">
